...
- [idle_in_transaction_session_timeout: Terminating idle transactions in Postgrehttps://www.cybertec-postgresql.com/en/idle_in_transaction_session_timeout-terminating-idle-transactions-in-postgresql/)SQL](
## HA
